    ...
    public function run()
    {
        ...
        for ($i = 1; $i <= 9; $i++) {
            Product::create([
                ...
                'description' => 'Lorem ' . $i . ' ipsum dolor sit amet, consectetur adipisicing elit. Ipsum temporibus iusto ipsa, asperiores voluptas unde aspernatur praesentium in? Aliquam, dolore!',
                'image' => "products/$date/desktop-$i.jpg",
            ])->categories()->attach(2);
        }
        ...
        for ($i = 1; $i <= 9; $i++) {
            Product::create([
                ...
                'description' => 'Lorem ' . $i . ' ipsum dolor sit amet, consectetur adipisicing elit. Ipsum temporibus iusto ipsa, asperiores voluptas unde aspernatur praesentium in? Aliquam, dolore!',
                'image' => "products/$date/phone-$i.jpg",
            ])->categories()->attach(3);
        }
        ...
        for ($i = 1; $i <= 9; $i++) {
            Product::create([
                ...
                'description' => 'Lorem ' . $i . ' ipsum dolor sit amet, consectetur adipisicing elit. Ipsum temporibus iusto ipsa, asperiores voluptas unde aspernatur praesentium in? Aliquam, dolore!',
                'image' => "products/$date/tablet-$i.jpg",
            ])->categories()->attach(4);
        }
        ...
        for ($i = 1; $i <= 9; $i++) {
            Product::create([
                ...
                'description' => 'Lorem ' . $i . ' ipsum dolor sit amet, consectetur adipisicing elit. Ipsum temporibus iusto ipsa, asperiores voluptas unde aspernatur praesentium in? Aliquam, dolore!',
                'image' => "products/$date/camera-$i.jpg",
            ])->categories()->attach(6);
        }
